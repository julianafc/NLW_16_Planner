...
const formatador = (data) => {
  return {
    ...
    mes: {
      mesCurto: dayjs(data).format('MMM'),
      mesLongo: dayjs(data).format('MMMM')
    },
...
const criarItemDeAtividade = (atividade) => {
  ...
  <div class="card-bg">
     ...
     <time class="short">
      ...
      ${formatar.mes.mesCurto} <br>
      ${formatar.hora}
     </time>
     <time class="full">${formatar.dia.semana.longo},
     dia ${formatar.dia.numerico}
     de ${formatar.mes.mesLongo}
...
const salvarAtividade = (event) => {
  ...
  const novaAtividade = {
    nome, //nome: nome ou simplesmente nome
    data,
    finalizada: false //começa no false pois acabamos de colocar a atividade então ainda não foi finalizada
  }
